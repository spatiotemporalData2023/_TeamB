		...
		const latPara = parseFloat(urlParams.get('lat'));
		const lngPara = parseFloat(urlParams.get('lng'));
		const pathPara = urlParams.get('path');
		let lat_f = document.getElementById('latitude');
		let lng_f = document.getElementById('longitude');
		lat_f.value = latPara;
		lng_f.value = lngPara;
